...
class UserService:
    ...
    def getUserDetails(self, pid: int) -> UserDetails | None:
        """Get UserDetails.
        Args:
            pid: the user pid for the user we want details for
        Returns:
            UserDetails | None: the details for the given user or none if the Event does not exist.
        Raises:
        ...
        if user_entity is None:
            ...
            model = user_entity.to_details_model()
            return model
